...
void noiseGenerator(int** grid, int density = 10, int Width = 119, int Height = 30) {
    srand(time(0));
...
void iteration (int** grid, int Width = 119, int Height = 30, int iteration = -1) {
...
int main() {
    ...
    noiseGenerator(grid, ScrnWidth, ScrnHeight);
